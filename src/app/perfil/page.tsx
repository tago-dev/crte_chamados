                ...
                <section className="grid gap-6">
                    <header>
                        ...
                        <p className="text-sm text-slate-400">
                            Atualize suas informações pessoais para manter seu perfil completo.
                        </p>
                    </header>

                    <div className="rounded-xl border border-white/10 bg-slate-900 p-6">
                        <form action={handleUpdateProfile} className="grid gap-4 md:grid-cols-2">
                            <div>
                            ...
                            <div>
                                ...
                                <p className="mt-1 text-xs text-slate-500">
                                    Email gerenciado pelo sistema de autenticação
                                </p>
                            </div>
